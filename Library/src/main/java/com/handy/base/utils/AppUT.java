 ...
 */
public class AppUT {
    private static AppUT appUT = null;

    private AppUT() {
    }

    public synchronized static AppUT getInstance() {
        if (appUT == null) {
            appUT = new AppUT();
        }
        return appUT;
    ...
    private Intent getIntentByPackageName(Context context, String packageName) {
     ...
     * @param packageName 包名
     */
    public void openAppInfo(Context context, String packageName) {
     ...
     * @param info    分享信息
     */
    public void shareAppInfo(Context context, String info) {
