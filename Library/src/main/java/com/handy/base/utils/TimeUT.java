...
public class TimeUT {
     ...
     * </pre>
     */
    private static TimeUT timeUT = null;
    private final SimpleDateFormat DEFAULT_SDF = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault());

    private TimeUT() {
    }

    public synchronized static TimeUT getInstance() {
        if (timeUT == null) {
            timeUT = new TimeUT();
        }
        return timeUT;
     ...
     * @param milliseconds 毫秒时间戳
     * @param unit         <ul>
     *                     <li>{@link ConstUT.TimeUnit#MSEC}: 毫秒</li>
     *                     <li>{@link ConstUT.TimeUnit#SEC }: 秒</li>
     *                     <li>{@link ConstUT.TimeUnit#MIN }: 分</li>
     *                     <li>{@link ConstUT.TimeUnit#HOUR}: 小时</li>
     *                     <li>{@link ConstUT.TimeUnit#DAY }: 天</li>
     *                     </ul>
     * @return unit时间戳
     */
    private long milliseconds2Unit(long milliseconds, ConstUT.TimeUnit unit) {
        switch (unit) {
            case MSEC:
                return milliseconds / ConstUT.getInstance().MSEC;
            case SEC:
                return milliseconds / ConstUT.getInstance().SEC;
            case MIN:
                return milliseconds / ConstUT.getInstance().MIN;
            case HOUR:
                return milliseconds / ConstUT.getInstance().HOUR;
            case DAY:
                return milliseconds / ConstUT.getInstance().DAY;
        }
        return -1;
    }
     ...
     * @return unit时间戳
     */
    public long getIntervalTime(String time0, String time1, ConstUT.TimeUnit unit) {
     ...
     * @return unit时间戳
     */
    public long getIntervalTime(String time0, String time1, ConstUT.TimeUnit unit, SimpleDateFormat format) {
     ...
     * @return unit时间戳
     */
    public long getIntervalTime(Date time0, Date time1, ConstUT.TimeUnit unit) {
     ...
     * @return unit时间戳
     */
    public long getIntervalByNow(String time, ConstUT.TimeUnit unit) {
     ...
     * @return unit时间戳
     */
    public long getIntervalByNow(String time, ConstUT.TimeUnit unit, SimpleDateFormat format) {
     ...
     * @return unit时间戳
     */
    public long getIntervalByNow(Date time, ConstUT.TimeUnit unit) {
