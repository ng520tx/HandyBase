...
public class EncryptUT {
    ...
    private static EncryptUT encryptUT = null;
    ...
    public synchronized static EncryptUT getInstance() {
        if (encryptUT == null) {
            encryptUT = new EncryptUT();
        }
        return encryptUT;
    }
    ...
    public String encryptMD2ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptMD2(data));
    }
    ...
    public String encryptMD5ToString(String data, String salt) {
        return ConvertUT.getInstance().bytes2HexString(encryptMD5((data + salt).getBytes()));
    }
    ...
    public String encryptMD5ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptMD5(data));
    }
    ...
    public String encryptMD5ToString(byte[] data, byte[] salt) {
        ...
        return ConvertUT.getInstance().bytes2HexString(encryptMD5(dataSalt));
    }
    ...
    public String encryptSHA1ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptSHA1(data));
    }
    ...
    public String encryptSHA224ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptSHA224(data));
    }
    ...
    public String encryptSHA256ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptSHA256(data));
    }
    ...
    public String encryptSHA384ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptSHA384(data));
    }
    ...
    public String encryptSHA512ToString(byte[] data) {
        return ConvertUT.getInstance().bytes2HexString(encryptSHA512(data));
    }
     ...
     * @return 密文字节数组
     */
    private byte[] encryptAlgorithm(byte[] data, String algorithm) {
        try {
    ...
    public String encryptMD5File2String(File file) {
        return encryptMD5File(file) != null ? ConvertUT.getInstance().bytes2HexString(encryptMD5File(file)) : "";
    }
     ...
     */
    public byte[] DESTemplet(byte[] data, byte[] key, String algorithm, String transformation, boolean isEncrypt) {
        try {
    ...
    public byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return EncodeUT.getInstance().base64Encode(encryptDES(data, key));
    }
    ...
    public String encryptDES2HexString(byte[] data, byte[] key) {
        return ConvertUT.getInstance().bytes2HexString(encryptDES(data, key));
    }
    ...
    public byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(EncodeUT.getInstance().base64Decode(data), key);
    }
    ...
    public byte[] decryptHexStringDES(String data, byte[] key) {
        return decryptDES(ConvertUT.getInstance().hexString2Bytes(data), key);
    }
    ...
    public byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return EncodeUT.getInstance().base64Encode(encrypt3DES(data, key));
    }
    ...
    public String encrypt3DES2HexString(byte[] data, byte[] key) {
        return ConvertUT.getInstance().bytes2HexString(encrypt3DES(data, key));
    }
    ...
    public byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(EncodeUT.getInstance().base64Decode(data), key);
    }
    ...
    public byte[] decryptHexString3DES(String data, byte[] key) {
        return decrypt3DES(ConvertUT.getInstance().hexString2Bytes(data), key);
    }
    ...
    public byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return EncodeUT.getInstance().base64Encode(encryptAES(data, key));
    }
    ...
    public String encryptAES2HexString(byte[] data, byte[] key) {
        return ConvertUT.getInstance().bytes2HexString(encryptAES(data, key));
    }
    ...
    public byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(EncodeUT.getInstance().base64Decode(data), key);
    }
    ...
    public byte[] decryptHexStringAES(String data, byte[] key) {
        return decryptAES(ConvertUT.getInstance().hexString2Bytes(data), key);
    }
