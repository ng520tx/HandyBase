...
public class ThreadPoolUT {
     ...
     */
    private ThreadPoolUT(Type type, int corePoolSize) {
        //构造有定时功能的线程池
    ...
    public synchronized static ThreadPoolUT getInstance(Type type, int corePoolSize) {
        return new ThreadPoolUT(type, corePoolSize);
    }
